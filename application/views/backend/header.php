<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                ...
                <?php endif; ?>
                <b><img src="<?php echo base_url();?>assets/images/learning.png" alt="home" style="width: 50px;height: 50px;"/></b><span class="hidden-xs">E - <strong>Learning</strong></span></a></div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="http://localhost:81/elearning2/uploads/admin_image/1.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php
